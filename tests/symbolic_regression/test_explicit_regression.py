...
@pytest.mark.parametrize("relative, expected_fitness",
                         [(False, 2.5), (True, 1.0)])
def test_explicit_regression(explicit_data, relative, expected_fitness):
    dummy_training_data = explicit_data[0]
    dummy_sum_equation = explicit_data[1]
    regressor = ExplicitRegression(dummy_training_data, relative=relative)
