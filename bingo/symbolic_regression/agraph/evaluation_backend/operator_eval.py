...
def _integer_reverse_eval(_reverseindex, _param1, _param2, _forwardeval, _reverseeval):
    pass
...
def _loadx_reverse_eval(_reverseindex, _param1, _param2, _forwardeval, _reverseeval):
    pass
...
def _loadc_reverse_eval(_reverseindex, _param1, _param2, _forwardeval, _reverseeval):
    pass
...
def _add_reverse_eval(reverse_index, param1, param2, _forwardeval, reverse_eval):
...
def _subtract_reverse_eval(reverse_index, param1, param2, _forwardeval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index]
    reverse_eval[param2] -= reverse_eval[reverse_index]
...
def _multiply_reverse_eval(reverse_index, param1, param2, forward_eval, reverse_eval):
...
def _divide_reverse_eval(reverse_index, param1, param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] / forward_eval[param2]
    reverse_eval[param2] -= (
        reverse_eval[reverse_index] * forward_eval[reverse_index] / forward_eval[param2]
    )
...
def _sin_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] * np.cos(forward_eval[param1])
...
def _cos_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] -= reverse_eval[reverse_index] * np.sin(forward_eval[param1])


# Tangent
def _tan_forward_eval(param1, _param2, _x, _constants, forward_eval):
    return np.tan(forward_eval[param1])


def _tan_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] / (
        np.cos(forward_eval[param1]) ** 2
    )
...
def _sinh_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] * np.cosh(forward_eval[param1])
...
def _cosh_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] * np.sinh(forward_eval[param1])
...
def _tanh_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] / (
        np.cosh(forward_eval[param1]) ** 2
    )
...
def _exp_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
...
def _log_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
...
def _pow_reverse_eval(reverse_index, param1, param2, forward_eval, reverse_eval):
    reverse_eval[param1] += (
        reverse_eval[reverse_index]
...
def _safe_pow_reverse_eval(reverse_index, param1, param2, forward_eval, reverse_eval):
    reverse_eval[param1] += (
        reverse_eval[reverse_index]
        * forward_eval[reverse_index]
        * forward_eval[param2]
...
def _abs_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += reverse_eval[reverse_index] * np.sign(forward_eval[param1])
...
def _sqrt_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    reverse_eval[param1] += (
        0.5
        * reverse_eval[reverse_index]
        / forward_eval[reverse_index]
...
# Inverse Sine
def _asin_forward_eval(param1, _param2, _x, _constants, forward_eval):
    return np.arcsin(forward_eval[param1])


def _asin_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    xsqr = (forward_eval[param1]) ** 2
    reverse_eval[param1] += reverse_eval[reverse_index] / np.sqrt(
        np.ones_like(xsqr) - xsqr
    )


# Inverse Cosine
def _acos_forward_eval(param1, _param2, _x, _constants, forward_eval):
    return np.arccos(forward_eval[param1])


def _acos_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    xsqr = (forward_eval[param1]) ** 2
    reverse_eval[param1] -= reverse_eval[reverse_index] / np.sqrt(
        np.ones_like(xsqr) - xsqr
    )
...
# Inverse Tangent
def _atan_forward_eval(param1, _param2, _x, _constants, forward_eval):
    return np.arctan(forward_eval[param1])


def _atan_reverse_eval(reverse_index, param1, _param2, forward_eval, reverse_eval):
    xsqr = (forward_eval[param1]) ** 2
